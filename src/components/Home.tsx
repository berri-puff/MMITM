  ...
  return (
    <div>
      ...
      <div className="m-20">
        ...
        <button className="btn btn-neutral  mr-5">Neutral</button>
        <button className="btn btn-primary  mr-5">Primary</button>
        <button className="btn btn-secondary  mr-5">Secondary</button>
        <button className="btn btn-accent  mr-5">Accent</button>
        <button className="btn btn-ghost  mr-5">Ghost</button>
        <button className="btn btn-link  mr-5">Link</button>
      </div>

      <div className="m-20 flex flex-row">
        <div className="card w-96 bg-base-100 shadow-xl basis-1/4  mr-5">
          <figure>
            <img
